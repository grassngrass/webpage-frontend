...
export default function SignupPage() {
  return (
    <div className="relative min-h-screen w-screen text-white flex items-center justify-center overflow-hidden">
      ...
      <Image className="absolute h-auto w-2/5 opacity-80" src="/globe.png" alt="globe" width="1024" height="1024" />
        ...
        <form className="flex flex-col space-y-6 z-5">
          <div>
            ...
            <input
              ...
              className="w-full px-6 py-2 bg-transparent  border-[#FFFFFF] rounded-sm-[#FFFFFF] font-rubik-mono-one focus:outline-none focus:border-[#FFFFFF] border-2"
            />
          </div>
          <div>
            <label className="block text-xs font-rubik-mono-one #FFFFFF mb-1">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-transparent  border-[#FFFFFF] rounded-sm-[#FFFFFF] font-rubik-mono-one focus:outline-none focus:border-[#FFFFFF] border-2"
            />
          </div>
